/**
* Copyright (c) D. Schneider, 2017 <daedae@gmx.ch>
*
...
DotStarPainterCanvas::DotStarPainterCanvas(Adafruit_DotStar* Pixels)
{
...
DotStarPainterCanvas::~DotStarPainterCanvas(void)
{
	if(_canvas) free(_canvas); 
}

bool DotStarPainterCanvas::isvalid(void)
{
	if(_canvas) return true;
	else return false;
}

void  DotStarPainterCanvas::clear() //clear all hsv fade pixels on the canvas
{
	memset(_canvas, 0, _LED->numPixels()*sizeof(hsvcanvas));
}

//update & transfer the hsv canvas to the LEDs
void DotStarPainterCanvas::transfer(void){
...
void DotStarPainterCanvas::addColorRGB(int index, RGB color)
{
	RGB nowcolor;
...
void DotStarPainterCanvas::addColorHSV(int index, uint8_t H, uint8_t S, uint8_t V)
{
	RGB color;
...
RGB DotStarPainterCanvas::HSVtoRGB(uint8_t H, uint8_t S, uint8_t V) {
	RGB returncolor;
...
DotStarPainterBrush::DotStarPainterBrush(DotStarPainterCanvas* hsv_canvas)
{
...
DotStarPainterBrush::~DotStarPainterBrush(void)
{
	if(_brush) free(_brush); //todo: is this a good idea???
}

bool DotStarPainterBrush::isvalid(void)
{
...
void DotStarPainterBrush::paint(void){
...
void DotStarPainterBrush::moveTo(uint16_t position)
{
...
int16_t DotStarPainterBrush::getPosition(void)
{
	return _brush->i>>SPEEDSHIFT;
}

void DotStarPainterBrush::setSpeed(int16_t speed)
{
	_brush->speed = speed;
}
uint16_t DotStarPainterBrush::getSpeed(void)
{
	return _brush->speed;
}
void DotStarPainterBrush::setSpeedlimit(int16_t limit)
{
	_brush->speedlimit = limit;
}

void DotStarPainterBrush::setColor(HSV color)
{
	_brush->hue = color.h;
...
HSV DotStarPainterBrush::getColor(void)
{
	HSV returncolor;
...
void  DotStarPainterBrush::setFadeSpeed(uint8_t fadeSpeed)
{
	_brush->fadespeed = fadeSpeed;
}
uint8_t DotStarPainterBrush::getFadeSpeed(void)
{
	return _brush->fadespeed;
}
void DotStarPainterBrush::setFadeout(bool value)
{
	_brush->fadevalue_out = value;
}

void DotStarPainterBrush::setFadein(bool value)
{
	_brush->fadevalue_in = value;
}


void DotStarPainterBrush::setFadeHueNear(bool value)
{
	_brush->fadehue_near = value;
}

void DotStarPainterBrush::setFadeHueFar(bool value)
{
	_brush->fadehue_far = value;
}

void DotStarPainterBrush::setFadeSaturation_in(bool value)
{
	_brush->fadesaturation_in = value;
}

void DotStarPainterBrush::setFadeSaturation_out(bool value)
{
	_brush->fadesaturation_out = value;
}

void DotStarPainterBrush::setBounce(bool value)
{
	_brush->bounce = value;
}
