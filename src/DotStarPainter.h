...
#ifndef DotStarPainter_h
#define DotStarPainter_h
...
public:
	...
	void transfer(void);
	hsvcanvas* _canvas;
	Adafruit_DotStar* _LED; //pointer to DotStars
...
private:
	brush* _brush; 
	DotStarPainterCanvas* _canvastopaint;
};
